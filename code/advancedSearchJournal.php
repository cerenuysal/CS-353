...
<ul>
  ...
  <li><a class="active" href="advancedSearchJournal.php#journal">Journal</a></li>
...
<div align="center"> <br><br><br>
 <label>Advanced Search for journal<br><br></label>
  <form class="example" action="/libraryJournal.php" style="margin:auto;max-width:300px;height:50%" align="center">
    ...
    <br>
    <input type = "button" onclick="location.href='libraryJournal.php';" style="font-size:18px" value="Search">
  </form>
</div>
